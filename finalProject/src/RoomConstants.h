...
Room room8({ 37,61 }, { 185,209 }, {}, {}, { HitBox({ 85,160,0 },{ 135,209,kWallHeight }) }, {
...
Room hallway11({ -12,136 }, { 37, 307 }, {}, {}, { HitBox({ 12,160,0 },{ 37,283,kWallHeight }) }, {});
...
Door door43({ 185 - kHitboxDims.x, -455 + kHitboxDims.y, 0 }, { 185 + kHitboxDims.x, -430 - kHitboxDims.y, 2 * kHeight }, &room4, &hallway18);
Door door44({ 209 - kHitboxDims.x, -455 + kHitboxDims.y, 0 }, { 209 + kHitboxDims.x, -430 - kHitboxDims.y, 2 * kHeight }, &hallway18, &room14);

Room room16({ -433,160 }, { -357,234 }, {}, {}, {}, {});
Room hallway16({ -357,185 }, { -258,209 }, {}, {}, {}, {});
Door door33({ -258 - kHitboxDims.x, 185 + kHitboxDims.y, 0 }, { -258 + kHitboxDims.x, 209 - kHitboxDims.y, 2 * kHeight }, &room5, &hallway16);
Door door34({ -357 - kHitboxDims.x, 185 + kHitboxDims.y, 0 }, { -357 + kHitboxDims.x, 209 - kHitboxDims.y, 2 * kHeight }, &hallway16, &room16);
...
Door door31({ -258 + kHitboxDims.x, 283 - kHitboxDims.y, 0 }, { -233 - kHitboxDims.x, 283 + kHitboxDims.y, 2 * kHeight }, &room5, &hallway17);
Door door32({ -258 + kHitboxDims.x, 308 - kHitboxDims.y, 0 }, { -233 - kHitboxDims.x, 308 + kHitboxDims.y, 2 * kHeight }, &hallway17, &room17);
